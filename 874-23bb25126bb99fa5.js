...
(self.webpackChunk_N_E = self.webpackChunk_N_E || []).push([[874], {
    ...
    2757: (e, t, r) => {
        ...
        function u(e) {
            ...
            e.port && (c += ":" + e.port)),
            f && "object" == typeof f && (f = String(n.urlQueryToSearchParams(f)));
            let s = e.search || f && "?" + f || "";
            return u && !u.endsWith(":") && (u += ":"),
            e.slashes || (!u || o.test(u)) && !1 !== c ? (c = "//" + (c || ""),
            i && "/" !== i[0] && (i = "/" + i)) : c || (c = ""),
            a && "#" !== a[0] && (a = "#" + a),
            s && "?" !== s[0] && (s = "?" + s),
            "" + u + c + (i = i.replace(/[?#]/g, encodeURIComponent)) + (s = s.replace("#", "%23")) + a
        }
    ...
    6874: (e, t, r) => {
        ...
        function y(e) {
            let t, r, n, [i,y] = (0,
            u.useOptimistic)(p.IDLE_LINK_STATUS), b = (0,
            u.useRef)(null), {href: P, as: E, children: v, prefetch: _=null, passHref: O, replace: j, shallow: T, scroll: N, onClick: C, onMouseEnter: S, onTouchStart: A, legacyBehavior: L=!1, onNavigate: x, ref: U, unstable_dynamicOnHover: I, ...k} = e;
            t = v,
            L && ("string" == typeof t || "number" == typeof t) && (t = (0,
            o.jsx)("a", {
                children: t
            }));
            let w = u.default.useContext(a.AppRouterContext)
              , M = !1 !== _
              , R = null === _ ? f.PrefetchKind.AUTO : f.PrefetchKind.FULL
            ...
            , [P, E]);
            L && (r = u.default.Children.only(t));
            let K = L ? r && "object" == typeof r && r.ref : U
              , B = u.default.useCallback(e => (null !== w && (b.current = (0,
            p.mountLinkInstance)(e, D, w, R, M, y)),
            () => {
                b.current && ((0,
                p.unmountLinkForCurrentNavigation)(b.current),
                b.current = null),
                (0,
              ...
              , z = {
                ...
                onClick(e) {
                    ...
                    w && (e.defaultPrevented || function(e, t, r, n, o, i, a) {
                        ...
                        if (!("A" === f.toUpperCase() && function(e) {
                            ...
                            u.default.startTransition( () => {
                                ...
                                (0,
                                h.dispatchNavigateAction)(r || t, o ? "replace" : "push", null == i || i, n.current)
                            }
                            )
                        }
                    }(e, D, F, b, j, N, x))
            ...
            return (0,
            s.isAbsoluteUrl)(F) ? z.href = F : L && !O && ("a" !== r.type || "href"in r.props) || (z.href = (0,
            l.addBasePath)(F)),
            n = L ? u.default.cloneElement(r, z) : (0,
            o.jsx)("a", {
                ...k,
                ...z,
                children: t
        ...
        r(3180);
        let m = (0,
        u.createContext)(p.IDLE_LINK_STATUS)
          , b = () => (0,
        u.useContext)(m);
